...
router.get("/flightInfo/:airlineCode/:flightNumber/:originFlightDate", function (req, res) {
    ...
    // 
    getAMSFlightData(airlineCode, flightNumber, originFlightDate);
    var args = {
        headers: {}
    };
    ...
    client.get("https://api-dev.munich-airport.de/aci-flight-v1/flightDetails/"
        + airlineCode + "/" + flightNumber + "/" + originFlightDate, args, function (data, response) {
        console.log(data);
        res.send(data);
    });
});
function getAMSFlightData(airlineCode, flightNumber, originFlightDate) {
    ...
    var args = {
        ...
        parameters: { app_id: "a5ce65e3", app_key: "34e2fc05aed1f047beeedb6c629972c1", airline: "KL" }
    };
    // args["headers"]["ResourceVersion: v3"] = "d017a45398ba4a8e14b7fe534fb9b54a";
    client.get("https://api-acc.schiphol.nl/public-flights/flights", args, function (data, response) {
